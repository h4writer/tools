...
alias inbound32='        export JS="'$REPO'/js/src/build-32"'
alias inbound32d='       export JS="'$REPO'/js/src/build-32-debug"'
alias inbound32p='       export JS="'$REPO'/js/src/build-32-parallel"'
alias inbound32do='      export JS="'$REPO'/js/src/build-32-debug-opt"'
alias inbound64='        export JS="'$REPO'/js/src/build-64"'
alias inbound64d='       export JS="'$REPO'/js/src/build-64-debug"'
alias inbound64p='       export JS="'$REPO'/js/src/build-64-parallel"'
alias inbound64do='      export JS="'$REPO'/js/src/build-64-debug-opt"'
alias inboundTL='        export JS="'$REPO'/js/src/build-tracelogging"'
alias inboundTLdo='      export JS="'$REPO'/js/src/build-tracelogging-debug-opt"'
alias inboundTLd='       export JS="'$REPO'/js/src/build-tracelogging-debug"'
alias inboundTLGGC='     export JS="'$REPO'/js/src/build-tracelogging-ggc"'
alias inboundARM='       export JS="'$REPO'/js/src/build-arm"'
alias inboundARMd='      export JS="'$REPO'/js/src/build-arm-debug"'
alias inboundARMdo='     export JS="'$REPO'/js/src/build-arm-debug-opt"'
alias inboundBook='      export JS="'$REPO'/js/src/build-book"'
alias inboundBookd='     export JS="'$REPO'/js/src/build-book-debug"'
alias inboundBookdo='    export JS="'$REPO'/js/src/build-book-debug-opt"'
alias inboundSoftBook='  export JS="'$REPO'/js/src/build-soft-book"'
alias inboundSoftBookd=' export JS="'$REPO'/js/src/build-soft-book-debug"'
alias inboundSoftBookdo='export JS="'$REPO'/js/src/build-soft-book-debug-opt"'
alias inboundClang='     export JS="'$REPO'/js/src/build-clang"'
